...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!DatabaseConnection.instance) {
      ...
      console.log("%cLa conexión a la base de datos ha sido realizada", COLORS.yellow);
    }
  ...
  public connect(): void {
    ...
    if (this.connected) {
      console.log("%cYa estabamos conectados a la base de datos", COLORS.red);
      return;
    }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      console.log("%cDesconectamos la conexión a la base de datos", COLORS.blue);
